...
var createLabRequest = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, slotId, doctorId, patientId, laboratoryId, tests, newlabRequest;
    return __generator(this, function (_b) {
        _a = req.body, slotId = _a.slotId, doctorId = _a.doctorId, patientId = _a.patientId, laboratoryId = _a.laboratoryId, tests = _a.tests;
        newlabRequest = new labRequest_1.default({ slotId: slotId, doctorId: doctorId, patientId: patientId, laboratoryId: laboratoryId, tests: tests });
